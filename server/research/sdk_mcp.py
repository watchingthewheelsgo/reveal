...
def _build_tools() -> list[SdkMcpTool[Any]]:
    handlers: list[tuple[str, ToolHandler]] = [
        ...
        ("stock_watch_add", reveal_mcp.stock_watch_add),
        ("stock_watch_remove", reveal_mcp.stock_watch_remove),
        ("market_movers_status", reveal_mcp.market_movers_status),
        ("market_movers_check", reveal_mcp.market_movers_check),
        ("market_movers_recent", reveal_mcp.market_movers_recent),
        ...
        ("reddit_watch_list", reveal_mcp.reddit_watch_list),
        ("reddit_watch_add", reveal_mcp.reddit_watch_add),
        ("reddit_watch_remove", reveal_mcp.reddit_watch_remove),
        ("reddit_latest", reveal_mcp.reddit_latest),
        ("reddit_search", reveal_mcp.reddit_search),

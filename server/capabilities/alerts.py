...
async def get_alert_status_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "price_critical_pct": settings.alert_price_critical_pct,
        "volume_ratio": settings.alert_volume_ratio,
        "volume_critical_ratio": settings.alert_volume_critical_ratio,
        "stock_watch_critical_multiplier": settings.stock_watch_critical_multiplier,
